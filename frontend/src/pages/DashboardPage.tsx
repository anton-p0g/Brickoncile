...
export function DashboardPage() {
  ...
  const [sort, setSort] = usePersistentState<SortOption>("dashboard.sort", "least-complete", isSortOption);
  ...
  const [themeFilter, setThemeFilter] = usePersistentState<ThemeFilter>(
    "dashboard.themeFilter",
    ALL_THEMES,
    isThemeFilter,
  );
  const [ownedSearch, setOwnedSearch] = usePersistentState("dashboard.search", "", isString);
  const [groupByThemeEnabled, setGroupByThemeEnabled] = usePersistentState(
    "dashboard.groupByTheme",
    false,
    isBoolean,
  );
